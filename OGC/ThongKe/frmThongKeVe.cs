...
namespace OGC.ThongKe
{
    public partial class frmThongKeVe : Form
    {
        ...
        {
            string tenFile = "ThongKeVe";

            if (rdbVe_LoaiPhong.Checked)
            {
                tenFile = "ThongKeVe_TheoLoaiPhong";
            }
            else if (rdbVe_SuatChieu.Checked)
            {
                tenFile = "ThongKeVe_TheoSuatChieu";
            }
            else if (rdbSoVe_Phim.Checked)
            {
                tenFile = "ThongKeVe_TheoPhim";
            }

            XuatExcelTuDataGridView(dgvKetQuaThongKe_Ve, tenFile);
        }
    }
}
