...
namespace OGC.ThongKe
{
    public partial class frmThongKeDoanhThu : Form
    {
        ...
        {
            string tenFile = "ThongKeDoanhThu";

            if (rdbDoanhThu_NhanVien.Checked)
            {
                tenFile = "ThongKeDoanhThu_TheoNhanVien";
            }
            else if (rdbDoanhThu_Phim.Checked)
            {
                tenFile = "ThongKeDoanhThu_TheoPhim";
            }
            else if (rdbDoanhThu_SuatChieu.Checked)
            {
                tenFile = "ThongKeDoanhThu_TheoSuatChieu";
            }

            XuatExcelTuDataGridView(dgvKetQuaThongKe_DoanhThu, tenFile);
        }
    }
}
