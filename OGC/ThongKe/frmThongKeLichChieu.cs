...
namespace OGC.ThongKe
{
    public partial class frmThongKeLichChieu : Form
    {
        ...
        {
            string tenFile = "ThongKeLichChieu";

            if (rdbLichChieu_SoLuongKhach.Checked)
            {
                tenFile = "ThongKeLichChieu_SoLuongKhach";
            }
            else if (rdbLichChieu_VangKhach.Checked)
            {
                tenFile = "ThongKeLichChieu_VangKhach";
            }
            else if (rdbLichChieu_SoLuongPhim.Checked)
            {
                tenFile = "ThongKeLichChieu_SoLuongPhim";
            }
            else if (rdbLichChieu_DongKhach.Checked)
            {
                tenFile = "ThongKeLichChieu_DongKhach";
            }

            XuatExcelTuDataGridView(dgvKetQuaThongKe_LichChieu, tenFile);
        }
    }
}
